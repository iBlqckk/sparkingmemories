...
const FOTOS = [
  { src: foto1.url, caption: "Siempre con las manos listas", date: "En el trabajo" },
  { src: foto2.url, caption: "El descanso bien merecido", date: "En la finca" },
  { src: foto3.url, caption: "Nuestro equipo de siempre", date: "Padre e hijo" },
  { src: foto4.url, caption: "Puro cariño y buena vibra", date: "En familia" },
];
